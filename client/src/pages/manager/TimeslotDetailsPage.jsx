      ...
      <div className="bg-white shadow rounded-lg p-6 mb-6">
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <TimeslotStatusBadge status={isActive ? 'active' : 'ended'} className="mt-2" />
          </div>
          <div className="text-right">
            <p className="text-sm text-gray-500">Location: {timeslot.location}</p>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div>
            <p className="text-gray-600">
              <span className="font-medium">Starts:</span> {formatConsultationTime(timeslot.startTime)}
            </p>
            <p className="text-gray-600">
              <span className="font-medium">Ends:</span> {formatConsultationTime(timeslot.endTime)}
            </p>
          </div>
        ...
        {isActive ? (
          ...
          <div className="bg-gray-50 p-4 rounded-lg text-center">
            <h2 className="text-xl font-semibold mb-2">Consultation Session Has Ended</h2>
            <p className="text-gray-600">
